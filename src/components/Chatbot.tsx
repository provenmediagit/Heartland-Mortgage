    ...
    <>
      {!isOpen && (
        ...
        >
          ...
          <div className="w-8 h-8 bg-foreground/10 rounded-full flex items-center justify-center pointer-events-none group-hover:bg-primary/20 transition-colors">
            <MessageCircle className="h-4 w-4 text-foreground group-hover:text-primary transition-colors" />
          </div>
        </div>
      )}

      {isOpen && (
        <Card className="fixed bottom-6 right-6 z-50 flex w-[350px] flex-col shadow-2xl h-[500px] border-border">
