    ...
    <div className="py-20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-2">
           <Reveal from="left" className="sticky top-24 h-max">
           ...
           <Reveal from="right" className="bg-card p-6 sm:p-8 rounded-3xl border border-border">
               ...
               <div ref={timelineRef} className="space-y-6 relative">
                  ...
                  <motion.div
                    ...
                    className="absolute left-3 top-2 bottom-2 w-px bg-primary origin-top"
                  />
                  {steps.map((step, index) => (
                      <Reveal key={index} from="left" y={30} delay={0} className="flex gap-4 relative z-10 bg-background sm:bg-transparent">
        ...
        <Reveal className="mt-20 border-t border-border pt-16 text-center max-w-2xl mx-auto">
