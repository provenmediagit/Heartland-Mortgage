      ...
      <section className="bg-background pt-24 pb-16 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
            How Your <span className="text-primary italic">Rate</span> is Determined
          </h1>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid gap-6">
            {determinants.map((factor, index) => (
              <div 
                key={index} 
                className="bg-card p-8 rounded-2xl border border-border shadow-sm flex flex-col md:flex-row gap-6 items-start"
              >
