        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          <Reveal>
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
              Document <span className="hm-text-shimmer italic">Checklist</span>
            </h1>
              ...
              <Stagger className="space-y-6">
                {documents.map((doc, index) => (
                  <StaggerItem key={index}>
                    <TiltCard
                      max={6}
                      className="flex gap-4 items-start p-4 rounded-2xl md:bg-transparent bg-background md:border-none border border-border transition-shadow hover:shadow-lg"
                    >
              ...
              <div className="mt-12 pt-8 border-t border-border">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <Magnetic strength={0.25} className="w-full">
                    <Button asChild size="lg" className="w-full h-auto py-6 flex flex-col items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all rounded-2xl">
                  ...
                  <Magnetic strength={0.25} className="w-full">
                    <Button asChild variant="outline" size="lg" className="w-full h-auto py-6 flex flex-col items-center justify-center gap-2 border-border hover:bg-muted/50 rounded-2xl">
